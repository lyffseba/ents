...
If you discover a security vulnerability within `44`, please do NOT open a public issue.
Instead, send a direct message or open a private advisory via GitHub under the `lyffseba/44` repository. We aim to address critical execution or dependency vulnerabilities within 48 hours.